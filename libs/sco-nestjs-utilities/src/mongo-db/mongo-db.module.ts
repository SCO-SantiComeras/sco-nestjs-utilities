...
export interface MongoAsyncConfig
  ...
  useFactory?: (
    ...args: any[]
  ) => Promise<MongoDbConfig> | MongoDbConfig;
}
...
export class MongoDbModule {
  ...
  private static createConnectProviders(
    ...
    return [
      {
        provide: 'CONFIG_OPTIONS',
        useFactory: async (optionsFactory: MongoConfigFactory) =>  await optionsFactory.createMongoConfig(),
