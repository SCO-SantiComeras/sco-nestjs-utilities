...
@ApiTags('Permissions')
export class PermissionsControllerJwt {
  ...
  @ApiOperation({
    ...
    description: 'Return permissions, it can be filtered by QUERY params. Authguard required',
  })
  @ApiQuery({
  ...
  @ApiOperation({
    ...
    description: 'Add a new permission. Authguard required',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description: 'Update an existing permission. Authguard required',
  })
  @ApiParam({
  ...
  @ApiOperation({
    ...
    description: 'Delete an existing permission. Authguard required',
  })
  @ApiParam({
