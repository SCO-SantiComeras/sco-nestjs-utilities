...
@ApiTags('Roles')
export class RolesControllerJwt {
  ...
  @ApiOperation({
    summary: `Fetch roles`,
    description: 'Return roles, it can be filtered by QUERY params. Authguard required',
  })
  @ApiQuery({
  ...
  @ApiOperation({
    summary: `Add role`,
    description: 'Add a new role. Authguard required',
  })
  @ApiBody({
  ...
  @ApiOperation({
    summary: `Update role`,
    description: 'Update an existing role. Authguard required',
  })
  @ApiParam({
  ...
  @ApiOperation({
    summary: `Delete role`,
    description: 'Delete an existing role. Authguard required',
  })
  @ApiParam({
